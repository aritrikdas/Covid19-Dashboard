        ...
        return (
            <div className="row tile_count title-rest-world">
                <div className="col-md-2 col-sm-4 col-xs-6 tile_stats_count title-content-india">
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/in.png" class="title-flag" />
                            <span className="count_top d-block"> India</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">2500</span>
                ...
                <div className="col-md-2 col-sm-4 col-xs-6 tile_stats_count title-content-india">
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/us.png" class="title-flag" />
                            <span className="count_top d-block"> USA</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">123781</span>
                            <span className="count_bottom"><i className="red"><i className="fa fa-sort-asc" />4% </i> Today</span>
                ...
                <div className="col-md-2 col-sm-4 col-xs-6 tile_stats_count title-content-india">
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/it.png" class="title-flag" />
                            <span className="count_top d-block"> Italy</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">92472</span>
                            <span className="count_bottom"><i className="red"><i className="fa fa-sort-asc" />4% </i> Today</span>
                ...
                <div className="col-md-2 col-sm-4 col-xs-6 tile_stats_count title-content-india">
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/cn.png" class="title-flag" />
                            <span className="count_top d-block"> Chaina</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">81439</span>
                            <span className="count_bottom"><i className="red"><i className="fa fa-sort-asc" />4% </i> Today</span>
                    ...
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/es.png" class="title-flag" />
                            <span className="count_top d-block"> Spain</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">78797</span>
                            <span className="count_bottom"><i className="red"><i className="fa fa-sort-asc" />4% </i> Today</span>
                    ...
                    <div class="d-flex">
                        <div>
                            <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/de.png" class="title-flag" />
                            <span className="count_top d-block"> Germany</span>
                        </div>
                        <div class="top-title-counter-wrapper">
                            <span class="count red">58247</span>
                            <span className="count_bottom"><i className="red"><i className="fa fa-sort-asc" />4% </i> Today</span>
                ...
                {/* <div className="d-flex title-rest-world">
                    <div className="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                        <div class="d-flex">
                            <div>
                                <img src="https://raw.githubusercontent.com/NovelCOVID/API/master/assets/flags/mu.png" class="title-flag" />
                                <span className="count_top d-block"> India</span>
                            </div>
                            <div class="top-title-counter-wrapper">
                                <span class="count red">2500</span>
